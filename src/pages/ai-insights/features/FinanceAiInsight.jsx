...
import { financeInsightsData } from "../../../lib/aiInsights";
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full text-left text-sm">
          <thead className="text-gray-500 bg-[#EEF2FF]">
            <tr>
              <th className="px-4 py-4 font-bold text-black">Category</th>
          ...
          <tbody className="text-gray-700">
            {financeInsightsData.map((item, index) => (
              <tr key={index} className="border-t last:border-b">
                <td className="px-4 py-4 font-normal">{item.category}</td>
...
export default FinanceAiInsights;