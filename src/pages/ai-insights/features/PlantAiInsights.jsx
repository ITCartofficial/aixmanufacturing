...
import { plantInsightData } from "../../../lib/aiInsights";

const PlantAiInsights = () => {
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full text-left text-sm">
          <thead className="text-gray-500 bg-[#EEF2FF]">
            <tr>
              <th className="px-4 py-4 font-bold text-black">Plant Name</th>
          ...
          <tbody className="text-gray-700">
            {plantInsightData.map((item, index) => (
              <tr key={index} className="border-t last:border-b">
                <td className="px-4 py-4 font-normal">{item.plantName}</td>
...
export default PlantAiInsights;
