...
const Sidebar = () => {
  return (
    <div className="h-screen w-[260px] py-3 bg-[#ffffff] px-4 flex flex-col justify-start">
      <ul className="flex flex-col gap-2">
        <li className="text-[16px] flex items-center font-semibold text-[#4B4B4B] cursor-pointer hover:text-[#ffffff] hover:bg-[#5D60EF] py-3 px-3 rounded-[10px]">
